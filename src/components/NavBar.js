					...
					<div className="flex space-x-7">
						<div>
							...
							<a href="#home" className="flex items-center py-4 px-2">
								<img src={CompIcon} alt="Logo" className="h-8 w-8 mr-2"/>
						...
						<div className="hidden md:flex items-center space-x-1">
							...
							<a href="#technologies" className="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Technologies</a>
						</div>
					</div>
					{/* secondary items */}
					<div className="hidden md:flex items-center space-x-3 ">
						<a href="#home" className="py-2 px-2 font-medium text-gray-500 rounded hover:bg-green-500 hover:text-white transition duration-300">Log In</a>
